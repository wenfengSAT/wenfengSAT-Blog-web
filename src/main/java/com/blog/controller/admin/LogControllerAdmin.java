...
public class LogControllerAdmin {
	...
	public Map<String, Object> selectBlogListByDate(Log log, @RequestParam(value = "startTime") String startTime,
	...
	@ResponseBody
	@AccessLimit(seconds = 1, maxCount = 10)
	public Map<String, Object> selectLogListByDate(Log log, @RequestParam(value = "startTime") String startTime,
