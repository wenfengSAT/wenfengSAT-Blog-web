...
import com.blog.util.SubStringUtil;
...
public class BlogControllerAdmin {
	...
	public Map<String, Object> deletePic(String prarm, String path, HttpServletRequest request) throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	public Map<String, Object> selectLikeBlogListByPage(Blog blog,
	...
	public Map<String, Object> selectGroupLikeBlogListByPage(Blog blog,
