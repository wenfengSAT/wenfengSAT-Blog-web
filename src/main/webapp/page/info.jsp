    		...
    		success : function(data) {
    			if(data.result != "" && data.result != null){
    				...
    				for(var i = 0; i < comments.length; i++){
    			        ...
    			        '<a href="javascript:;" name="1" class="date-dz-pl pl-hf hf-con-block pull-left">回复</a> <span class="pull-left date-dz-line">|</span> <a href="javascript:;" class="date-dz-z pull-left"><i class="date-dz-z-click-red"></i>赞 (<i class="z-num">666</i>)</a> </div> </div><div class="hf-list-con"></div></div> </div>';
    				}
...
<script type="text/javascript">
    $('.comment-show').on('click','.hf-pl',function(){
        ...
        var commentId = oThis.prop("name1");
        console.log("commentId:"+commentId+"--"+oThis.name);
