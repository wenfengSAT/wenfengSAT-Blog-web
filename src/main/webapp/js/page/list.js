    ...
    $.ajax({
      ...
      success : function(data) {
        ...
        if (data.length > 0) {
          ...
          blogList = "<h3 style='font-size:20px;text-align:center;margin:20px;'>" +
          		"Sorry, the resources you visited don't exist~</h3><h3 style='text-align:center;' class='font-bold'>" +
          		"抱歉，你所访问的资源不存在~</h3><h4 style='margin-bottom:110px;margin-top:55px;text-align:center;'>" +
          		"<a style='background-color: #676a6c;padding: 5px 10px;color: #fff;border-radius: 10px;' href='index.jsp'>去首页</a></h4>";
        }
        if (page.pageNum >= 2) {
